...
const Page04 = () => {
  return (
    <div className="w-full">
        ...
        <div className="relative flex w-full flex-col md:flex-row items-center justify-center bg-[#265C5C] text-white p-6 md:p-8 mx-auto overflow-hidden ">
            {/* Left Content */}
            <div className="space-y-6 md:w-1/2 text-left ml-10 ">
                {/* Virtual Cards Button */}
                <Button className="bg-[#265C5C] border-2 border-white px-4 py-2 text-lg uppercase">
                    Virtual Cards
                </Button>
                ...
                <h2 className="text-3xl md:text-3xl font-bold leading-tight">
                    ...
                    <Button className="bg-[#B1FCDE] text-[#265C5C] px-6 py-3 text-lg md:text-3xl font-bold rounded-[20px] shadow hover:bg-gray-100 transition m-2 ">
                    subscriptions
                    </Button>
                ...
                <Button className="bg-white text-[#265C5C] px-6 py-3 text-lg font-bold rounded-md shadow hover:bg-gray-100 transition">
                    Get virtual card
                </Button>
            </div>
